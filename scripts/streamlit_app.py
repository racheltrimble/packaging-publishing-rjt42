...
def train_and_save_model(
    ...
    """Train a model from the supplied training data and save the model to a pickle file

    Args:
        train_data (pd.Dataframe): The training data
        filename (str, optional): The output filename. Defaults to 'cancer_model.pkl'.

    Returns:
        CancerModel: The trained cancer model instance.
    """
    model = CancerModel()
